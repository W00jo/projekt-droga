...
# Create as many poolable obstacles, as declared in "initial_size" for the obstacle pool (PoolManager)
func _initialise_obstacle_pool():
	var obstacle_pool_size: int = PoolManager._pool_configs["obstacle"]["initial_size"]
